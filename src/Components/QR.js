	...
	render(){
		return(
			<div className="Home" style={{"padding-top":"15vh","padding-bottom":"20vh", "text-align":"center", "height": "100%"}}>
				<h2 style={{"color":"white","padding-top":"15vh","padding-bottom":"10vh", "padding-left":"5vh","padding-right":"5vh"}}> Zeig diesen Code einfach dem Empfänger, um dein Paket abzuholen </h2>
